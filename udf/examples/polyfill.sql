...
SELECT polyfill('POLYGON ((43.604652 1.444209, 47.218371 -1.553621, 50.62925 3.05726, 48.864716 2.349014, 43.6961 7.27178, 3.604652 1.444209))', 2)
...
RETURNS ARRAY(BIGINT)
LAMBDA 'arn:aws:lambda:<region>:<account>:function:<functionname>'
SELECT polyfill('POLYGON ((43.604652 1.444209, 47.218371 -1.553621, 50.62925 3.05726, 48.864716 2.349014, 43.6961 7.27178, 3.604652 1.444209))', 4) AS polyfillh3s)
